...
import Logo from "../assets/Jatirasa.png"
...
const Navbar = () => {
    ...
    return (
        <div className='bg-amber-950 px-4 md:px-0 fixed z-50 w-full top-0 shadow-[0_5px_6px_rgba(0,0,0,0.5)]'>
            <div className='max-w-7xl mx-auto flex justify-between items-center py-2'>
                {/* logo section */}
                <div className='flex items-center'>
                    <img src={Logo} alt="" className='w-10 h-10' />
                    <h1 className='text-2xl text-white font-cursive italic'>Jati Rasa</h1>
                </div>
                {/* menu section */}
